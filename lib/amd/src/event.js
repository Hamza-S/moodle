...
define(['jquery', 'core/yui'],
    ...
    return /** @alias module:core/event */ {
        ...
        /**
         * Trigger an event using both JQuery and YUI
         * This event notifies that a region needs redrawing.
         *
         * @method notifyEditorContentRestored
         * @param {DOMElement} element
         */
        notifyRegionResized: function(element) {
            Y.use('event', 'moodle-core-event', function(Y) {
                // Trigger it the JQuery way.
                $(document).trigger(M.core.event.REGION_RESIZED, element);

                // And again for YUI.
                Y.fire(M.core.event.REGION_RESIZED, element);
            });
        },
    };
});
