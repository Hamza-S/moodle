...
$string['librarygroup5'] = 'Chemistry';
$string['librarygroup5_desc'] = 'TeX commands for chemistry listed on the chemistry tab.';
$string['librarygroup6'] = 'Figures';
$string['librarygroup6_desc'] = 'TeX commands for drawing and figures listed on the figures tab.';
