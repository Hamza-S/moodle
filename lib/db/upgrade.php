...
function xmldb_main_upgrade($oldversion) {
    ...
    if ($oldversion < 2018120303.12) {
        ...
        upgrade_main_savepoint(true, 2018120303.12);
    }

    if ($oldversion < 2018120303.14) {
        ...
        // Main savepoint reached.
        upgrade_main_savepoint(true, 2018120303.13);
    }
    ...
    if ($oldversion < 2019042400.00) {
        ...
        // Main savepoint reached.
        upgrade_main_savepoint(true, 2018120303.14);
    }
