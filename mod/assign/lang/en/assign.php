...
$string['submissionstatement'] = 'Submission statement for single user assignments';
$string['submissionstatement_help'] = 'Assignment submission confirmation statement';
$string['submissionstatementdefault'] = 'This assignment is my own work, except where I have acknowledged the use of the works of other people and cited them correctly.';
$string['submissionstatement_help'] = 'This statement is shown for assignments in single user mode.';
$string['submissionstatementteamsubmission'] = 'Submission statement for team submissions';
$string['submissionstatementteamsubmissiondefault'] = 'I\'m submitting this assignment on behalf of my entire group and I confirm for me and my group members on behalf that this is our own work. If we have acknowledged the use of the works of other people, we cited them correctly.';
$string['submissionstatementteamsubmission_help'] = 'This statement is shown for the user who submits a solution on behalf of all other group members.';
$string['submissionstatementteamsubmissionallsubmit'] = 'Submission statement for team submissions (each member must submit)';
$string['submissionstatementteamsubmissionallsubmitdefault'] = 'I\'m submitting this assignment as a group member and I confirm that this is our own work. If we have acknowledged the use of the works of other people, we cited them correctly.';
$string['submissionstatementteamsubmissionallsubmit_help'] = 'This statement is shown to each member of the group when submitting the group draft.';
